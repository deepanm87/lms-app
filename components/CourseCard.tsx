...
export function CourseCard({ course, progress, href }: CourseCardProps) {
  return (
    ...
    >
      <div className="bg-card rounded-xl overflow-hidden shadow-lg transition-all duration-300 ease-in-out hover:shadow-xl hover:translate-y-[-4px] border-border flex flex-col flex-1">
        {course.image ? (
          <Image 
